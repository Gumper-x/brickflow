...
export default defineBrickflowUiConfig({
  uiStyles: {
    button: {
      ...
      base: 'relative inline-flex cursor-pointer items-center justify-center overflow-hidden font-sans font-medium whitespace-nowrap transition duration-150 ease-in select-none focus-visible:outline-2 focus-visible:outline-offset-2 active:scale-105 desktop:bg-red-400',
      color: {
        alt: {
